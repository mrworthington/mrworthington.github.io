...
# margin-header: |
#  ![](https://mattfortexas51.com/2.svg)
# output:
format:
  html:
    date_format: medium
    ...
    # toc: false
    # toc_depth: 2
title-block-banner: fullsizeoutput_77ff.jpg
title-block-banner-color: "#ffffff"
categories:
  - School Finance
  - Recapture
  - Public Education
image: fullsizeoutput_77ff.jpg
---
:::{.callout-note}
Note: This story was originally published by [Folo Media](https://hebfdn.org/echoes/past-and-present/).
:::

*In case you missed it: Matt Worthington joined State Rep. Diego Bernal and SAISD's Chief Innovation Officer Mohammad Choudhury on TPR's The Source to discuss school finance in San Antonio. Listen to their conversation [here](http://tpr.org/post/texas-has-broken-school-finance-system-can-it-be-fixed).*
