...
format:
  html:
    ...
    css: page_header.css
    fig-width: 8
image: ryan-magsino-sohLeI-k-HU-unsplash.jpg
title-block-banner: ryan-magsino-sohLeI-k-HU-unsplash.jpg
...
tx_zips <- tigris::zctas(state="TX", cb=FALSE, year = 2010) 
...
<strong>TLDR \| </strong>Why not do this at the statewide level?
...
read_excel("TexasCOVID19CaseCountData.xlsx", sheet = "Tests", skip=1) %>% 
  clean_names() %>% 
  slice(1:2) %>% 
  gt() %>%
...
Photo by <a href="https://unsplash.com/@rymagsino?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Ryan Magsino</a> on <a href="https://unsplash.com/s/photos/austin-ryan?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a>
